# Build the polygon-level training table for the 4-class workflow.
# This version preserves the original observer classes instead of collapsing
# the two middle classes into a single category.
